...
function makeBody($defaults) {
	...
	$bodyText = '
			...
			<div id="sideMenu">
                ...
                <div class="drawer-item btn active" data-link="homeTab">
                	<span class="barBtn"><i class="material-icons barIcon">home</i></span>Home
                </div>
                <div class="drawer-item btn" data-link="voiceTab">
                	<span class="barBtn"><i class="material-icons barIcon">list</i></span>Voice
                </div>
                <div class="drawer-item btn" data-link="logTab">
                	<span class="barBtn"><i class="material-icons barIcon">bug_report</i></span>Logs
                </div>
                <div class="drawer-item btn" data-link="generalSettingsTab">
                	<span class="barBtn"><i class="material-icons barIcon">settings</i></span>Settings
                </div>
                
                <div class="drawer-list collapsed">
                	<div class="drawer-wrap">
	                    <div class="drawer-item btn" data-link="plexSettingsTab">
	                        <span class="barBtn"><i class="material-icons barIcon">settings</i></span>Plex
	                    </div>
	                    <div class="drawer-item btn" data-link="movieFetcherSettingsTab">
	                        <span class="barBtn"><i class="material-icons barIcon">movie</i></span>Movies
	                    </div>
	                    <div class="drawer-item btn" data-link="showFetcherSettingsTab">
	                        <span class="barBtn"><i class="material-icons barIcon">live_tv</i></span>Shows
	                    </div>
	                    <div class="drawer-item btn" data-link="musicFetcherSettingsTab">
	                        <span class="barBtn"><i class="material-icons barIcon">music_note</i></span>Music
	                    </div>
	                </div>       
				</div>
				<div class="drawer-separator"></div>
				<div class="drawer-item btn" data-link="logout">
			...
			<div id="body">
		        ...
		        <div id="results">	    
			        ...
			        <div class="view-tab fade" id="voiceTab">
			            <div id="resultsInner"  class="queryWrap col-md-9 col-lg-8">
			            </div>
			        </div>
        			<div class="view-tab fade show active settingPage col-sm-9 col-lg-8" id="generalSettingsTab">           
            ...
            <div class="view-tab fade settingPage col-sm-9 col-lg-8" id="plexSettingsTab">
            ...
            <div class="view-tab fade settingPage col-sm-9 col-lg-8" id="movieFetcherSettingsTab">
            ...
            <div class="view-tab fade settingPage col-sm-9 col-lg-8" id="showFetcherSettingsTab">
	            <div class="modal-body" id="fetcherBody">
	                <div class="appContainer card">
	                    <div class="card-body">
        	...
        	<div class="view-tab fade settingPage col-sm-9 col-lg-8" id="musicFetcherSettingsTab">
				<div class="modal-body" id="fetcherBody">
					<div class="appContainer card">
						<div class="card-body">
